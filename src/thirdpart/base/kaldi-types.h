...
namespace kaldi {
  ...
  class StrSS{
    public:
      StrSS(std::string &st,std::stringstream* ss){
        st_ = st;
        ss_ = ss;
      }
      ...
      std::stringstream* getStrSS(){
        return ss_;
      }
      void setSS(std::stringstream* ss){
        ss_ = ss;
      }
    private:
      std::string st_;
  ...
  typedef std::vector<StrSS> vec_ss;
  typedef std::map<std::string,std::stringstream*> map_ss;
  typedef std::vector<std::vector<StrSS>> vec_ss_list;
  typedef std::vector<std::map<std::string,std::stringstream *>> map_ss_list;
  //add by zack end
