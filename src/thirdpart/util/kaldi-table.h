...
class RandomAccessTableReader {
 public:
  ...
  //add by zack start
  explicit RandomAccessTableReader(map_ss* rs,const std::string &range);
  //add by zack end

  // Opens the table.
  bool Open(const std::string &rspecifier);
  //add by zack start
  bool Open(map_ss* rs,const std::string &range);
  //add by zack end
...
class SequentialTableReader {
 public:
  ...
  //add by zack start 
  explicit SequentialTableReader(vec_ss* rs);
  //add by zack end
...
class TableWriter {
 public:
  ...
  //add by zack start
  explicit TableWriter(vec_ss* vs);
  //add by zack end
